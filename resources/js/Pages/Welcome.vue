    ...
    >
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center items-center pt-8 sm:justify-start sm:pt-0">
                ...
                <span class="ml-3 text-7xl" style="color: #EF3B2D;">
                    {{ this.$appName }}
                </span>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <Link :href="route('register')" class="underline text-gray-900 dark:text-white">
                                    {{ __('Register') }}
                                </link>
                            </div>
                        </div>
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        ...
                        <a :href="this.$tbpHost" class="ml-1 underline">
                            {{ __('Shop') }}
                        </a>
                    </div>
                </div>
